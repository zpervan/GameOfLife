...
{
    horizontal_start_position_ = Utility::CalculateHorizontalStartPosition(
        grid_cell_size_, grid_size_.column, Config::MainMenu::WIDTH + horizontal_center_point_);
    vertical_start_position_ = Utility::CalculateVerticalStartPosition(
        grid_cell_size_, grid_size_.row, Config::MenuBar::VERTICAL_SIZE + vertical_center_point_);
}
