...
INSTANTIATE_TEST_SUITE_P(GridSizeParametrizedExceptionTest,
                         GridSizeExceptionTestFixture,
...
TEST_F(GridTestFixture, GivenValidRowAndColumnSize_WhenCalculatingLineThickness_ThenLineThicknessIsCorrect)
{
