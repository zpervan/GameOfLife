...
echo "This script installs all needed dependencies to successfully run GameOfLife!"
...
echo -e " -- \e[33mInstalling dependencies for GameOfLife\e[0m"
...
echo -e " -- \e[33mSFML hotfix\e[0m"
cp -rv ${PWD}/ThirdParty/SFML-2.5.1/include/SFML/Window/* /usr/include/SFML/Window/
# cp -rv ${PWD}/ThirdParty/SFML-2.5.1/lib/* /lib/x86_64-linux-gnu
